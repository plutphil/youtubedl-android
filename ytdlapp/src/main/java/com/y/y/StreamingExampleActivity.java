...
import com.y.youtubedl_android.YoutubeDL;
import com.y.youtubedl_android.YoutubeDLRequest;
import com.y.youtubedl_android_example.BuildConfig;
import com.y.youtubedl_android_example.R;
...
public class StreamingExampleActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void handleIntent(Intent intent) {
        ...
        if (Intent.ACTION_VIEW.equals(appLinkAction) && appLinkData != null){
            etUrl.setText(appLinkData.toString());
            startStream(appLinkData.toString());
        }
    }
